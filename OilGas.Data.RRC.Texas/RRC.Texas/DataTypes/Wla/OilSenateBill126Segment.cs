...
namespace OilGas.Data.RRC.Texas
{
    [Serializable]
    [DataContract]
    [XmlRoot(nameof(OilSenateBill126Segment))]
    [Table(nameof(OilSenateBill126Segment))]
    public class OilSenateBill126Segment
    {
        [IgnoreDataMember]
        [XmlIgnore]
        [JsonIgnore]
        ...
        public OilSenateBill126Segment()
        {
        }

        public OilSenateBill126Segment(ReadOnlySpan<byte> source)
        {
            //02 WL-SB126-SEGMENT.
