...
namespace OilGas.Data.RRC.Texas
{
    [Serializable]
    [DataContract]
    [XmlRoot(nameof(GasSealedWellSegment))]
    [Table(nameof(GasSealedWellSegment))]
    public class GasSealedWellSegment
    {
        [IgnoreDataMember]
        [XmlIgnore]
        [JsonIgnore]
        ...
        public GasSealedWellSegment()
        {
        }

        public GasSealedWellSegment(ReadOnlySpan<byte> source)
        {
            //02 WL-OIL-GAS-SEALED-SEGMENT.
            //03 WL-SEALED-EFFECTIVE-DATE.
