...
namespace OilGas.Data.RRC.Texas
{
    [Serializable]
    [DataContract]
    [XmlRoot(nameof(GasWellRemarksSegment))]
    [Table(nameof(GasWellRemarksSegment))]
    public class GasWellRemarksSegment
    {
        [IgnoreDataMember]
        [XmlIgnore]
        [JsonIgnore]
        ...
        public GasWellRemarksSegment()
        {
        }

        public GasWellRemarksSegment(ReadOnlySpan<byte> source)
        {
            //02 WL-WELL-REMARKS.
